...
public class RsaPublicKeyReaderTest {
    ...
    private static final String SSH_ALGORITHM = "RSA";
    private static final String PUBLIC_KEY_STRING = "ssh-rsa " +
        ...
        "" + "/miiD2SLxHZ6RxAPW80bhXrzJMTLTCqhCEhzfv devel@ell,lake.67842b95c6cd11d892e2080020a0f4c9";
    ...
    public void setUp() {
        ...
        messageUnderTest = randomAlphanumeric(nextInt(8, 256));
    }
    ...
    public void decryptWithPublicKey() throws Exception {
        ...
        // checks that encrypted strings are the same
        assertThat(val1, is(val2));

        final RSAPublicKeySpec rsaPublicKeySpec = publicKeyReader.parsePublicKey(PUBLIC_KEY_STRING);
        cipher.init(DECRYPT_MODE, KeyFactory.getInstance(SSH_ALGORITHM).generatePublic(rsaPublicKeySpec));

        final String decrypted = new String(cipher.doFinal(Base64.decodeBase64(val1)), "UTF-8");
